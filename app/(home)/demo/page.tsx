...
export default function DemoPage() {
  return (
    <div className="flex w-full min-w-0 flex-1 flex-col font-montserrat text-[#333333]">
      <main className="relative flex flex-1 flex-col justify-center border-t border-black/10 bg-gradient-to-br from-[#0f1623] via-[#171717] to-[#0d1f2d] px-6 py-12 md:py-16">
